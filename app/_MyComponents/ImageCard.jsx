    ...
    <article>
      ...
      >
        ...
        >
          ...
          <Image
            src={
              !image?.ImageUrl || image?.ImageUrl === "https://example.com/image1.jpg"
                ? img
                : image.ImageUrl
            }
            ...
            quality={50} // 10 is very low, causes artifacts
            priority // ensures preload + eager load
            loading="eager" // explicitly eager (to silence Lighthouse warning)
            placeholder="blur"
